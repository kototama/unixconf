# set -gx PATH ~/projects/adhocracy3.mercator/bin $PATH
set -gx A3_ROOT ~/projects/adhocracy3.mercator
set -gx LD_LIBRARY_PATH ~/projects/adhocracy3.mercator/python/parts/opt/lib/
